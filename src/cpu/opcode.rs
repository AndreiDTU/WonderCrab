...
pub static CPU_OP_CODES: Lazy<Vec<OpCode>> = Lazy::new(|| {
    vec![
        ...
        OpCode::three_term(0x6B, "MUL", Operand::REGISTER, Operand::MEMORY, Operand::IMMEDIATE_S, Mode::M8),
        ...
        OpCode::one_byte(0x70, "BV",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x71, "BNV",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x72, "BC",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x73, "BNC",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x74, "BE",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x75, "BNE",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x76, "BNH",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x77, "BH",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),

        OpCode::one_byte(0x78, "BN",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x79, "BP",      Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7A, "BPE",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7B, "BPO",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7C, "BLT",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7D, "BGE",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7E, "BLE",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        OpCode::one_byte(0x7F, "BGT",     Operand::NONE,        Operand::IMMEDIATE_S, Mode::M16),
        ...
        OpCode::one_byte(0x9A, "CALL",    Operand::IMMEDIATE,   Operand::NONE,        Mode::M32),
        ...
        OpCode::one_byte(0xE0, "DBNZNE",  Operand::NONE,        Operand::IMMEDIATE_S, Mode::M8 ),
        OpCode::one_byte(0xE1, "DBNZE",   Operand::NONE,        Operand::IMMEDIATE_S, Mode::M8 ),
        OpCode::one_byte(0xE2, "DBNZ",    Operand::NONE,        Operand::IMMEDIATE_S, Mode::M8 ),
        ...
        OpCode::one_byte(0xE9, "BR",      Operand::IMMEDIATE_S, Operand::NONE,        Mode::M16),
        OpCode::one_byte(0xEA, "BR",      Operand::IMMEDIATE,   Operand::NONE,        Mode::M32),
        OpCode::one_byte(0xEB, "BR",      Operand::IMMEDIATE_S, Operand::NONE,        Mode::M8 ),
